...
- (courtyard_views)
    ...
    + (west_canis) Looking to the western side, <>
        -- you see an apothecary shop and main path entering {village01} (the one you followed in). No need to leave yet or visit that shop. You look around some more. ->courtyard_views
